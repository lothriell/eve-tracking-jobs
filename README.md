...
**Current Version:** v5.19.4 | **Build Date:** 2026-04-24
...
|---------|------|-------------|
| v5.19.4 | 2026-04-24 | UX: Collateral + Max m³ narrower (.narrow class); Max m³ placeholder bumped to 1,250,000 |
...
| v5.18.8 | 2026-04-23 | Fix: stock-check no longer applies to the root product (having one in stock zeroed out the plan) |
...
| v5.18.1 | 2026-04-23 | Production Planner inventory awareness (frontend): scope radio, pickers, tree stock chips, missing-only shopping list + multibuy |
